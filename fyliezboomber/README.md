...
```console
git clone https://github.com/fyliez/smsboomber
cd fyliezboomber
...
7- Bu token'ı *discord-selfbot-fyliez*'de *token* kısmına yazınız. (str olarak)<br>
...
4- Bu id'yi *discord-selfbot-fyliez.py*'de *chat_id* kısmına yazınız. (int olarak)<br><br>
